...
public class Armor {
	...
	public static class Item extends rpg.utilities.json.classes.items.Item {
		...
		public int getArmortype() {return this.armortype;}
		public void setArmortype(int armortype) {this.armortype = armortype;}
